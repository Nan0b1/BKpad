...
3rd: do the actual project (less easy):
- wiring everything logically with KiCAD
...
4th: making the code for the micro controller (this is difficult) and the website!
 - The Website is actually made with ODOO, a no code option. I tried that to see where the no code puts us and it confirms: this is not good. BUT it was done and pretty in less than 2 hours easly and this is for everyone to see, not just people that want to see that I have a html degree.
...
This project is likely the best keyboard that ever exister while being french, it masters ecological techniques like running on electricity and not coal and it can makes you text 25% faster someone while removing stress!<br></important>
